...
export default {
    ...
    manage: {
        ...
        deleteFolderConfirm: 'Are you sure you want to delete this folder and all images inside? This action cannot be undone.',
        folderDeleted: 'Folder deleted ({count} image records cleaned up)',
